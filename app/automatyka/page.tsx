    ...
    <div className="flex flex-col gap-8 ">
      ...
      <ul className="lg:flex md:flex-row md:gap-16 text-sm mt-12">
        <li className="pb-8 md:p-2 //md:border md:basis-1/2 lg:basis-1/3 ">
          <h2 className="text-lg text-blackdark:text-silverLight py-2 dark:text-white">
            .01
          </h2>
        ...
        <li className="pb-8 md:p-2 //md:border md:basis-1/2 lg:basis-1/3 ">
          <h2 className="text-lg text-black py-2 dark:text-white">.02</h2>
          <hr className="dark:text-white" />
          <p className="pt-2 dark:text-silverLight">
        ...
        <li className="pb-8 md:p-2 //md:border md:basis-1/2 lg:basis-1/3 ">
          <h2 className="text-lg py-2 text-black dark:text-white">.03</h2>
          <hr className="dark:text-white" />
          <p className="pt-2 dark:text-silverLight">
